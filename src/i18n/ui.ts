...
export const ui = {
  en: {
    ...
    'guard.title': 'Hold, traveler',
    'guard.body': 'Unusual activity detected. Please wait a moment before continuing.',
  ...
  fr: {
    ...
    'guard.title': 'Attendez, voyageur',
    'guard.body': 'Activité inhabituelle. Veuillez patienter.',
  ...
  de: {
    ...
    'guard.title': 'Halt, Reisender',
    'guard.body': 'Ungewöhnliche Aktivität erkannt. Bitte warte einen Moment.',
  ...
  es: {
    ...
    'guard.title': 'Detente, viajero',
    'guard.body': 'Actividad inusual detectada. Espera un momento.',
  ...
  it: {
    ...
    'guard.title': 'Fermati, viandante',
    'guard.body': 'Attività insolita rilevata. Attendi un momento.',
