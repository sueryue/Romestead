...
export const WORLD = {
  ...
  biomes: [
    ...
    },
    {
      ...
      desc: {
        en: 'The current endgame of Early Access. Extremely hostile NPCs that demand serious preparation — especially solo. The Phoenix is reborn in its crater and a colossal tendril tears from its heart.',
        fr: 'Le bout de l’Accès Anticipé. Des PNJ extrêmement hostiles exigeant une vraie préparation — surtout en solo. Le Phénix renaît dans son cratère et un tentacule colossal déchire son cœur.',
        de: 'Das aktuelle Endgame des Early Access. Extrem feindselige NPCs, die ernste Vorbereitung verlangen — besonders solo. Der Phönix wird im Krater wiedergeboren, ein kolossaler Tentakel reißt aus seinem Herzen.',
        es: 'El final del Acceso Anticipado. PNJ extremadamente hostiles que exigen preparación — sobre todo en solitario. El Fénix renace en su cráter y un tentáculo colosal se desgarra en su corazón.',
        it: 'L’endgame attuale dell’Early Access. NPC estremamente ostili che richiedono preparazione — soprattutto in solo. La Fenice rinasce nel cratere e un tentacolo colossale si squarcia nel cuore.',
      },
      threats: {
