...
export const GUIDES: Guide[] = [
  {
    ...
    answer: {
      en: 'Craft a torch before dusk and keep a ring of fire around your camp — torches and braziers push the Fallen back, and a simple palisade funnels the horde into choke points.',
  ...
  },
  {
    ...
    answer: {
      en: 'Ring the nest with coal traps and walk in circles — the traps burn the owl down while you dodge its dive and lightning.',
    ...
    quickFacts: {
      en: {
        location: "Light a campfire beneath Minerva's statue to mark the owl on your map",
        prereq: 'Accept the quest at your spawn, then break the egg to begin',
        rewards: "Guardian's Eye, Talon, Feathers and the Logistics Tent blueprint",
        gameVersion: '0.25.1_7',
      },
    },
    drops: {
      en: [
        { name: "Guardian's Eye", note: 'quest material — offer at your altar' },
        { name: "Guardian's Talon" },
        { name: 'Feathers', note: 'used for Feathered-tier gear' },
        { name: 'Logistics Tent blueprint', note: 'unlocks the Logistics Tent' },
      ],
    },
    tip: {
